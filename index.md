# hpa.spatial [![](reference/figures/hex.png)](https://healthpolicyanalysis.github.io/hpa.spatial/)
...
except it also includes a `simplify_keep` argument for simplifying the
polygon.
...
[`get_polygon()`](https://healthpolicyanalysis.github.io/hpa.spatial/reference/get_polygon.md)
can also access shapefiles for local hospital networks (LHNs) and
...
is used to map data across ASGS editions.
